...
function testdtoa() {
  function dtoa(bytes, num) {
    if (num !== num) {
      bytes[0] = 'N'.charCodeAt();
      bytes[1] = 'a'.charCodeAt();
      bytes[2] = 'N'.charCodeAt();
      return bytes.subarray(3);
    } else if (num === Infinity) {
      bytes[0] = 'I'.charCodeAt();
      bytes[1] = 'n'.charCodeAt();
      bytes[2] = 'f'.charCodeAt();
      return bytes.subarray(3);
    }  else if (num === -Infinity) {
      bytes[0] = '-'.charCodeAt();
      bytes[1] = 'I'.charCodeAt();
      bytes[2] = 'n'.charCodeAt();
      bytes[3] = 'f'.charCodeAt();
      return bytes.subarray(4);
    } else if (num == 0) {
      bytes[0] = '0'.charCodeAt();
      bytes[1] = 0;
