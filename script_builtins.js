...
function BuiltIns() {
  ...
  this.symbols = [
    ...
    new TSSymbol("%=", 0, false,
      [types.i32, Wasm.opcodes.i32_rem_s],
      [types.u32, Wasm.opcodes.i32_rem_u],
      [types.i64, Wasm.opcodes.i64_rem_s],
      [types.u64, Wasm.opcodes.i64_rem_u],
    ),
    new TSSymbol("&=", 0, false,
      [types.i32, Wasm.opcodes.i32_and],
      [types.u32, Wasm.opcodes.i32_and],
      [types.i64, Wasm.opcodes.i64_and],
      [types.u64, Wasm.opcodes.i64_and],
    ),//integer-specific assignment operators
    new TSSymbol("|=", 0, false,
      [types.i32, Wasm.opcodes.i32_or],
      [types.u32, Wasm.opcodes.i32_or],
      [types.i64, Wasm.opcodes.i64_or],
      [types.u64, Wasm.opcodes.i64_or],
    ),
    new TSSymbol("^=", 0, false,
      [types.i32, Wasm.opcodes.i32_xor],
      [types.u32, Wasm.opcodes.i32_xor],
      [types.i64, Wasm.opcodes.i64_xor],
      [types.u64, Wasm.opcodes.i64_xor],
    ),
    new TSSymbol("<<=", 0, false,
      [types.i32, Wasm.opcodes.i32_shl],
      [types.u32, Wasm.opcodes.i32_shl],
      [types.i64, Wasm.opcodes.i64_shl],
      [types.u64, Wasm.opcodes.i64_shl],
    ),
    new TSSymbol(">>=", 0, false,
      [types.i32, Wasm.opcodes.i32_shr_s],
      [types.u32, Wasm.opcodes.i32_shr_u],
      [types.i64, Wasm.opcodes.i64_shr_s],
      [types.u64, Wasm.opcodes.i64_shr_u],
    ),
    ...
    new TSSymbol("&", 6, false, //integer-specific operators
      [types.i32, Wasm.opcodes.i32_and],
      [types.u32, Wasm.opcodes.i32_and],
      [types.i64, Wasm.opcodes.i64_and],
      [types.u64, Wasm.opcodes.i64_and],
    ),
    new TSSymbol("|", 4, false,
      [types.i32, Wasm.opcodes.i32_or],
      [types.u32, Wasm.opcodes.i32_or],
      [types.i64, Wasm.opcodes.i64_or],
      [types.u64, Wasm.opcodes.i64_or],
    ),
    new TSSymbol("^", 5, false,
      [types.i32, Wasm.opcodes.i32_xor],
      [types.u32, Wasm.opcodes.i32_xor],
      [types.i64, Wasm.opcodes.i64_xor],
      [types.u64, Wasm.opcodes.i64_xor],
    ),
    new TSSymbol("<<", 7, false,
      [types.i32, Wasm.opcodes.i32_shl],
      [types.u32, Wasm.opcodes.i32_shl],
      [types.i64, Wasm.opcodes.i64_shl],
      [types.u64, Wasm.opcodes.i64_shl],
    ...
    new TSSymbol("!==", 3),
    new TSSymbol("==", 3, false,
      [types.i32, Wasm.opcodes.i32_eq],
      [types.u32, Wasm.opcodes.i32_eq],
      [types.i64, Wasm.opcodes.i64_eq],
      [types.u64, Wasm.opcodes.i64_eq],
    ), //comparison operators
    new TSSymbol("!=", 3, false,
      [types.i32, Wasm.opcodes.i32_eq, Wasm.opcodes.i32_eqz],
      [types.u32, Wasm.opcodes.i32_eq, Wasm.opcodes.i32_eqz],
      [types.i64, Wasm.opcodes.i64_eq, Wasm.opcodes.i64_eqz],
      [types.u64, Wasm.opcodes.i64_eq, Wasm.opcodes.i64_eqz],
    ),
    new TSSymbol(">", 3, false,
      [types.i32, Wasm.opcodes.i32_gt_s],
      [types.u32, Wasm.opcodes.i32_gt_u],
      [types.i64, Wasm.opcodes.i64_gt_s],
      [types.u64, Wasm.opcodes.i64_gt_u],
    ),
    new TSSymbol("<", 3, false,
    ...
    new TSSymbol(">=", 3, false,
      [types.i32, Wasm.opcodes.i32_ge_s],
      [types.u32, Wasm.opcodes.i32_ge_u],
      [types.i64, Wasm.opcodes.i64_ge_s],
      [types.u64, Wasm.opcodes.i64_ge_u],
    ),
    new TSSymbol("<=", 3, false,
      [types.i32, Wasm.opcodes.i32_le_s],
      [types.u32, Wasm.opcodes.i32_le_u],
    ...
    new TSSymbol("-", 10, true, //arithmetic negation operator
      ...
      [types.i64, Wasm.opcodes.i64_const, 0, Wasm.opcodes.i64_sub],
      [types.u64, Wasm.opcodes.i64_const, 0, Wasm.opcodes.i64_sub],
    ),
